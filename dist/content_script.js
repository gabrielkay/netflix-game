...
chrome.storage.onChanged.addListener(function(changes, namespace) {
  for (var key in changes) {
      ...
      if (storageChange.newValue != ""){
        ...
        (function initializeSubadub() {
          ...
          function vttTextToSimple(s, netflixRTLFix) {
            ...
            drink_func(simpleText);

            return simpleText;
          }

          function drink_func(text) {
            var drink = ` + `${drink_array}` + `;
            ...
            // button.style = "top:0;right:0;position:absolute;z-index:99999; padding: 20px; backgroundColor: transparent;"
            ...
            if (1==2){
              ...
              button.appendChild(drink_gif);

              //button.innerHTML = "Chug!";
              button.style = "top:5%;right:3%;position:absolute;z-index:99999; padding: 20px; color:white; font-size: 40px; -webkit-text-stroke: 1.5px black; height:20%; width:20%; background: none; border: none"
              document.body.appendChild(button);
            }
            else if (drink.some(w => text.toLowerCase().includes(w))) {
              console.log("DRINK")

              var drink_banner = document.createElement("div");
              var drink_text = document.createElement("div");
              drink_text.innerHTML = "word" + " - Drink!";
              var drink_gif = document.createElement("img");
              ...
              drink_banner.style = "top:5%;right:3%;position:absolute;z-index:99999; padding: 20px; color:white; font-size: 40px; -webkit-text-stroke: 1.5px black; height:20%; width:20%; background: none; border: none"
    ...
    if (key == "drink_storage"){
      drink_array = storageChange.newValue;
      console.log("drink_storage = " + drink_array);
    }
    if (key == "chug_storage"){
      chug_array = storageChange.newValue;
      console.log("chug_storage = " + chug_array);
    }
